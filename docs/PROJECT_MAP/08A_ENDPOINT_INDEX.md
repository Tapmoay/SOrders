...
| 2 | `POST /api/v1/auth/login` | `login_json` | `backend/app/api/v1/auth.py:70` | **公开** |
| 3 | `POST /api/v1/auth/token` | `login_form` | `backend/app/api/v1/auth.py:75` | **公开** |
...
| # | 方法与路径 | handler | 位置 | 授权 |
|---|---|---|---|---|
| 1 | `GET /api/v1/inventory/movements` | `list_movements` | `backend/app/api/v1/inventory.py:19` | 权限:PRODUCT_MANAGE |
| 2 | `POST /api/v1/inventory/movements` | `create_movement` | `backend/app/api/v1/inventory.py:41` | 权限:PRODUCT_MANAGE |
| 3 | `GET /api/v1/inventory/summary` | `inventory_summary` | `backend/app/api/v1/inventory.py:127` | 权限:PRODUCT_MANAGE |

### `backend/app/api/v1/ledger.py` — 13 个

| # | 方法与路径 | handler | 位置 | 授权 |
|---|---|---|---|---|
| 1 | `GET /api/v1/ledger/entries` | `list_entries` | `backend/app/api/v1/ledger.py:82` | 仅登录 + 体内仅允许:派单员\|货主 |
| 2 | `GET /api/v1/ledger/accounts` | `list_accounts` | `backend/app/api/v1/ledger.py:152` | 仅登录 + 体内仅允许:派单员 |
| 3 | `GET /api/v1/ledger/temp-shipper-names` | `list_temp_shipper_names` | `backend/app/api/v1/ledger.py:206` | 仅登录 + 体内仅允许:派单员 |
| 4 | `POST /api/v1/ledger/sync-from-delivered-orders` | `sync_ledger_from_delivered_orders` | `backend/app/api/v1/ledger.py:236` | 权限:LEDGER_EDIT |
| 5 | `POST /api/v1/ledger/entries` | `create_entry` | `backend/app/api/v1/ledger.py:251` | 权限:LEDGER_EDIT |
| 6 | `GET /api/v1/ledger/entries/{entry_id}` | `get_entry` | `backend/app/api/v1/ledger.py:322` | 仅登录 + 体内仅允许:派单员\|货主 |
| 7 | `PATCH /api/v1/ledger/entries/{entry_id}` | `update_entry` | `backend/app/api/v1/ledger.py:341` | 权限:LEDGER_EDIT |
| 8 | `DELETE /api/v1/ledger/entries/{entry_id}` | `delete_entry` | `backend/app/api/v1/ledger.py:446` | 权限:LEDGER_EDIT |
| 9 | `POST /api/v1/ledger/export-jobs` | `create_export_job` | `backend/app/api/v1/ledger.py:493` | 仅登录 + 体内权限:LEDGER_EDIT + 体内仅允许:派单员\|货主 |
| 10 | `GET /api/v1/ledger/export-jobs/{job_id}` | `get_export_job` | `backend/app/api/v1/ledger.py:603` | 仅登录 + 体内仅允许:派单员\|货主 |
| 11 | `GET /api/v1/ledger/export-jobs/{job_id}/download` | `download_export_job` | `backend/app/api/v1/ledger.py:624` | 仅登录 + 体内权限:LEDGER_EDIT + 体内仅允许:派单员\|货主 |
| 12 | `POST /api/v1/ledger/receipts` | `create_receipt_endpoint` | `backend/app/api/v1/ledger.py:668` | 仅登录 + 体内仅允许:派单员 |
| 13 | `GET /api/v1/ledger/receipts` | `list_receipts` | `backend/app/api/v1/ledger.py:715` | 仅登录 + 体内仅允许:派单员 |
...
| # | 方法与路径 | handler | 位置 | 授权 |
|---|---|---|---|---|
| 1 | `GET /api/v1/operation-logs` | `list_operation_logs` | `backend/app/api/v1/operation_logs.py:29` | 权限:OPERATION_LOG_READ |
| 2 | `GET /api/v1/operation-logs/{log_id}` | `get_operation_log` | `backend/app/api/v1/operation_logs.py:52` | 权限:OPERATION_LOG_READ |
...
| 12 | `POST /api/v1/orders/{order_id}/complete-with-upload` | `complete_order_with_upload` | `backend/app/api/v1/orders.py:740` | 权限:ORDER_COMPLETE_DRIVER + 体内含角色判断（需读源码） |
| 13 | `POST /api/v1/orders/{order_id}/driver-ack` | `driver_ack_view` | `backend/app/api/v1/orders.py:790` | 仅登录 + 体内仅允许:司机 |
| 14 | `POST /api/v1/orders/{order_id}/driver-note` | `driver_append_internal_note` | `backend/app/api/v1/orders.py:833` | 权限:ORDER_INTERNAL_NOTE + 体内仅允许:派单员\|司机 |
| 15 | `POST /api/v1/orders/{order_id}/navigation` | `fill_order_navigation` | `backend/app/api/v1/orders.py:861` | 仅登录 + 体内仅允许:派单员\|司机 |
| 16 | `POST /api/v1/orders/{order_id}/assign` | `assign_order` | `backend/app/api/v1/orders.py:981` | 权限:ORDER_DISPATCH |
| 17 | `POST /api/v1/orders/{order_id}/split` | `split_order_endpoint` | `backend/app/api/v1/orders.py:1033` | 权限:ORDER_DISPATCH |
| 18 | `POST /api/v1/orders/{order_id}/freight` | `update_order_freight` | `backend/app/api/v1/orders.py:1058` | 权限:ORDER_DISPATCH |
| 19 | `POST /api/v1/orders/{order_id}/complete` | `complete_order` | `backend/app/api/v1/orders.py:1214` | 权限:ORDER_COMPLETE_DRIVER |
| 20 | `POST /api/v1/orders/{order_id}/cancel` | `cancel_order` | `backend/app/api/v1/orders.py:1242` | 仅登录 + 体内权限:ORDER_CANCEL_SHIPPER + 体内权限:ORDER_CANCEL_DISPATCHER + 体内仅允许:派单员\|货主 |
| 21 | `POST /api/v1/orders/{order_id}/pay` | `pay_order` | `backend/app/api/v1/orders.py:1351` | 权限:ORDER_EDIT |
| 22 | `POST /api/v1/orders/{order_id}/charge` | `charge_order` | `backend/app/api/v1/orders.py:1377` | 权限:ORDER_EDIT |
| 23 | `POST /api/v1/orders/{order_id}/recall` | `recall_order` | `backend/app/api/v1/orders.py:1410` | 权限:ORDER_RECALL |

### `backend/app/api/v1/places.py` — 4 个

| # | 方法与路径 | handler | 位置 | 授权 |
|---|---|---|---|---|
| 1 | `GET /api/v1/places` | `list_places` | `backend/app/api/v1/places.py:34` | 仅登录 |
| 2 | `POST /api/v1/places` | `create_place` | `backend/app/api/v1/places.py:51` | 仅登录 |
| 3 | `POST /api/v1/places/{place_id}/use` | `use_place` | `backend/app/api/v1/places.py:82` | 仅登录 |
| 4 | `GET /api/v1/places/{place_id}` | `get_place` | `backend/app/api/v1/places.py:115` | 仅登录 |
...
| 2 | `GET /api/v1/price-rules` | `list_price_rules` | `backend/app/api/v1/price_rules.py:216` | 角色:dispatcher\|shipper |
| 3 | `POST /api/v1/price-rules` | `create_price_rule` | `backend/app/api/v1/price_rules.py:232` | 权限:PRICE_RULE_MANAGE |
| 4 | `GET /api/v1/price-rules/{rule_id}` | `get_price_rule` | `backend/app/api/v1/price_rules.py:281` | 权限:PRICE_RULE_MANAGE |
| 5 | `PATCH /api/v1/price-rules/{rule_id}` | `update_price_rule` | `backend/app/api/v1/price_rules.py:300` | 权限:PRICE_RULE_MANAGE |
| 6 | `DELETE /api/v1/price-rules/{rule_id}` | `delete_price_rule` | `backend/app/api/v1/price_rules.py:349` | 权限:PRICE_RULE_MANAGE |
...
| # | 方法与路径 | handler | 位置 | 授权 |
|---|---|---|---|---|
| 1 | `GET /api/v1/users/me` | `read_me` | `backend/app/api/v1/users.py:51` | 仅登录 |
| 2 | `GET /api/v1/users` | `list_users` | `backend/app/api/v1/users.py:56` | 权限:USER_MANAGE |
| 3 | `POST /api/v1/users` | `create_user` | `backend/app/api/v1/users.py:77` | 权限:USER_MANAGE |
| 4 | `GET /api/v1/users/{user_id}` | `get_user` | `backend/app/api/v1/users.py:126` | 仅登录 + 体内含角色判断（需读源码） |
| 5 | `GET /api/v1/users/{user_id}/product-visibility` | `get_product_visibility` | `backend/app/api/v1/users.py:136` | 仅登录 + 体内含角色判断（需读源码） |
| 6 | `PUT /api/v1/users/{user_id}/product-visibility` | `set_product_visibility` | `backend/app/api/v1/users.py:151` | 权限:USER_MANAGE + 体内含角色判断（需读源码） |
| 7 | `PATCH /api/v1/users/{user_id}` | `update_user` | `backend/app/api/v1/users.py:211` | 仅登录 + 体内含角色判断（需读源码） |
| 8 | `POST /api/v1/users/{user_id}/swap-shipper-driver` | `swap_shipper_driver` | `backend/app/api/v1/users.py:305` | 权限:USER_MANAGE + 体内含角色判断（需读源码） |
| 9 | `DELETE /api/v1/users/{user_id}` | `delete_user` | `backend/app/api/v1/users.py:329` | 权限:USER_MANAGE |
| 10 | `POST /api/v1/users/{user_id}/restore` | `restore_user` | `backend/app/api/v1/users.py:360` | 权限:USER_MANAGE |
...
| 方法与路径 | handler | 位置 |
|---|---|---|
| `POST /api/v1/auth/login` | `login_json` | `backend/app/api/v1/auth.py:70` |
| `POST /api/v1/auth/token` | `login_form` | `backend/app/api/v1/auth.py:75` |
...
| `GET /api/v1/users/me` | `read_me` | `backend/app/api/v1/users.py:51` | — |
