...
| 2 | `POST /api/v1/orders/{order_id}/driver-ack` | `driver_ack_view` | `backend/app/api/v1/orders_delivery.py:95` | 仅登录 + 体内仅允许:司机 |
| 3 | `POST /api/v1/orders/{order_id}/driver-note` | `driver_append_internal_note` | `backend/app/api/v1/orders_delivery.py:138` | 权限:ORDER_INTERNAL_NOTE + 体内仅允许:派单员\|司机 |
| 4 | `POST /api/v1/orders/{order_id}/navigation` | `fill_order_navigation` | `backend/app/api/v1/orders_delivery.py:177` | 仅登录 + 体内仅允许:派单员\|司机 |
