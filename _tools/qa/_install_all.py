...
DEVICES: list[tuple[str, str, str, str, tuple[str, ...]]] = [
    ("5554", "派单员", "13800000001", "SOrdersD", ("工作台 · 全量管理", "派单作业", "待派单池")),
    ("5556", "货主", "13800000002", "SOrdersAI", ("工作台 · 订单与账本", "我的订单")),
    ("5558", "司机", "13800000003", "SOrdersDriver", ("已完成", "进行中")),
]
# 判「登错了角色」只用这几个**强标志**（弱标志如「进行中」在别处也会出现，会误伤）
# ⚠️ 2026-09-22：工作台头部那条文案从「货主端 · 订单与账本」改成了「工作台 · 订单与账本」
#    （用户把头部压成一行、角色名挪进右边的描边胶囊，见 `ui/home/WorkbenchScreen.kt`），
